...
/**
 * Created by storm on 2017-07-08.
 */
...
//    private static String databasepath = "/data/data/com.hse/database"; // %s is packageName
private static String databasepath = CommonUrls.DATABASEPATH;
