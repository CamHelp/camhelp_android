...
public class PublishRepairActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void inittitle() {
        ...
        top_title.setText("宿舍报修");
        top_return.setOnClickListener(this);
    }

    public void initview() {
        webview = (WebView) findViewById(R.id.webview_repair);
        webview.loadUrl(CommonUrls.URL_REPAIR);
